...
void examples() {
    ...
    *ptr2 = 1;
    ...
    std::cout << "\nCreated a shared pointer shared_ptr1: " << *shared_ptr1 << " at the memory location of "
              << &shared_ptr1 << std::endl;

    // creating other pointer using copy constructor
    std::shared_ptr<double> shared_ptr2(shared_ptr1);

    std::cout << "Created shared_ptr2 using copy constructor (memory): " << &shared_ptr2 << " (value): " << *shared_ptr2
              << std::endl;
    ...
    std::cout << "Created shared_ptr3 using assignment (memory): " << &shared_ptr3 << " (value): " << *shared_ptr3
              << std::endl;
